...
I helped build [Meedan](https://meedan.com) from concept to a team of more than a dozen people, serving as Director of User Experience and Design. Meedan is a vibrant mission-driven company with a vision of a healthier, crosslingual internet. 

Meedan's key growth strategy has been to create a postitive feedback loop of sophisticated advocates in journalism circles. I contributed to this process as a design manager focused on what Doug Engelbart might call “improving the improving” through the development of freely available [usability test protocols](https://medium.com/meedan-updates/remote-usability-testing-with-invision-and-google-forms-126521d8779d) and [design standards](https://meedan-ui-guide.meedan.com/). We closely listened to journalists and network actors who wanted translation tools, and in turn they used these tools in highly visible ways that drove new users to Meedan.
