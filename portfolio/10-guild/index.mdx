...
![In 2018 I led an update of the company's identity and web presence. We positioned the Guild with our combination of core values and strategic assets.](guild.png)
...
<aside>
  <div class="content">
    ...
    <p>But would upstream investors want to support a thematic venture studio? See my colleague Beau's take on <a href="https://teetotality.blog/posts/climate-venture-studios/">Starting A Climate Studio</a>.</p>
  </div>
</aside>
...
![We worked to position the Guild in the context of major social and environmental change. These concepts were used as part of a fundraising initiative. My goal was to use color to capture energy of the Guild mission while grounding it in satellite and microscopic imagery.](guild2.png)
