...
The tragedy of New Orleans has given me some insight into the potential and limitations for this use of geospatial technologies. <img alt="NO-below-Sea-level" src="/images/NO-below-Sea-level.jpg" width="426" height="284" />
...
<img alt="niger-small" src="/images/niger-small.gif" width="200" height="150" href="http://www.reliefweb.int">Cusory searches of the internet  find that there certainly exists a great deal of straightforward mapping going on in terms of humanitarian crises, most notably (according to my notes) the indexes on <a href="http://www.Reliefweb.int">Reliefweb.int</a>. These are extremely useful documents for creating awareness, but they are also rich, multilayerd doccuments for use by the aidworkers and activists that cope with these problems daily. A pdf file of the crisis in Niger, for example, can be a great way to understand the scope of the problem, but it also can direct the triage more effectively. 
